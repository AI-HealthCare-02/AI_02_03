          ...
          <CardContent className="p-6 space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="p-4 bg-emerald-50 rounded-lg border border-emerald-200">
                ...
                <p className="text-sm text-gray-700">{analysisResult.impact_message}</p>
              </div>
            </div>
              ...
              {[
                ...
                <div key={title}>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {items.map((item) => (
                      <Badge key={item} variant="outline" className="border-green-300">
                        {item}
                      </Badge>
                    ))}
                  </div>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={title}>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {items.map((item) => (
                      <Badge key={item} variant="outline" className="border-red-300">
                        {item}
                      </Badge>
                    ))}
                  </div>
