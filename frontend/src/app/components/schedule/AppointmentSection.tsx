...
export function AppointmentSection({ appointments, onRefresh, calculateDday }: Props) {
  ...
  const confirmDelete = async () => {
    ...
    await api.delete(`/api/v1/appointments/${appointmentToDelete.id}`);
    ...
    <>
      <Card className="border-2 border-gray-200">
        ...
        {isOpen && (
          <CardContent className="space-y-4 border-t">
            {isAdding && (
              <div className="p-4 bg-blue-50/50 rounded-lg border border-gray-200">
            ...
            <div className="space-y-3">
              ...
              {appointments.length === 0 ? (
                ...
                appointments.map((apt) => (
                  <Card key={apt.id} className="border border-gray-200">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-600 mt-1 flex items-center gap-1">
                            ...
                            {format(new Date(apt.visit_date), "yyyy.MM.dd (E) HH:mm", {
                              locale: ko,
                            })}
                          </p>
                        </div>
                        ...
                        <div className="flex flex-col items-end gap-2">
                          <Badge className="bg-blue-100 text-blue-900">
                            {formatDday(new Date(apt.visit_date))}
                          </Badge>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              {appointmentToDelete?.hospital_name} 일정을 삭제할까요?
            </AlertDialogTitle>
            <AlertDialogDescription>
              삭제한 병원 일정은 다시 복구할 수 없습니다.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
